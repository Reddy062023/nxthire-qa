...
- Name: tests/features.spec.js >> Feature 1 — Create Candidate Manually >> TC-F01-01: Create candidate form opens on button click
- Location: tests/features.spec.js:117:3
