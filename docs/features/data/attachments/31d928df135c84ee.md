...
- Name: tests/features.spec.js >> Feature 8 — Requirements / Sales >> TC-F08-03 [BUG]: converting a requirement to a job should carry over salary and notes
- Location: tests/features.spec.js:682:3
