...
- Name: tests/features.spec.js >> Feature 1 — Create Candidate Manually >> TC-F01-02: Negative — letters not accepted in Years of experience field
- Location: tests/features.spec.js:148:3
