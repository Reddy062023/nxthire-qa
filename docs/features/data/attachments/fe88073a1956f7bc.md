...
- Name: feature9.spec.js >> Feature 9 — Interviews and Placements (standalone) >> TC-F09-01: Log interview — KPI ticks up
- Location: tests/feature9.spec.js:52:3
...
```ts
  1   | // ============================================================
  2   | // Feature 9 — Interviews and Placements (standalone)
