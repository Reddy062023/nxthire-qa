...
- Name: tests/features.spec.js >> Feature 5 — Email Button and Templates >> TC-F05-05: Save as template — custom template appears in dropdown after reopening
- Location: tests/features.spec.js:427:3
