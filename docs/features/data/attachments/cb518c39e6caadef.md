...
- Name: tests/features.spec.js >> Feature 5 — Email Button and Templates >> TC-F05-02 [BUG]: creating a candidate with no email should show a validation message, not "Failed to fetch"
- Location: tests/features.spec.js:372:3
