...
- Name: tests/features.spec.js >> Feature 4 — Word Resume Download >> TC-F04-01: Word resume button present on candidate detail
- Location: tests/features.spec.js:345:3
