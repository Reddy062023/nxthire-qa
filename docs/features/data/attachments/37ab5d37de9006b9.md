...
- Name: tests/features.spec.js >> Feature 2 — Parse Resume on Create >> TC-F02-03: Resume card shows on candidate detail after parse-create
- Location: tests/features.spec.js:254:3
