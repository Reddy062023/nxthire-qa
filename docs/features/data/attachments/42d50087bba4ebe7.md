...
- Name: tests/features.spec.js >> Feature 6 — Verification Checklist and Duplicate Check >> TC-F06-02: Verification checklist item persists as ticked after reload
- Location: tests/features.spec.js:482:3
