...
- Name: tests/features.spec.js >> Feature 1 — Create Candidate Manually >> TC-F01-03: New candidate appears in candidates list after creation
- Location: tests/features.spec.js:162:3
