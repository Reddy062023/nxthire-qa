...
- Name: tests/features.spec.js >> Feature 5 — Email Button and Templates >> TC-F05-03: Email modal opens with template applied
- Location: tests/features.spec.js:395:3
