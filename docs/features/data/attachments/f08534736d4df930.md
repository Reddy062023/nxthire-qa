...
- Name: tests/features.spec.js >> Feature 3 — Edit Candidate >> TC-F03-02/03: Edit candidate — change name and add skill then save
- Location: tests/features.spec.js:277:3
