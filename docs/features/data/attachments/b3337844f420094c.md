...
- Name: tests/features.spec.js >> Feature 10 — Vendors and Email Sequences >> TC-F10-04 [BUG]: vendor email sequence should substitute {{recruiter_name}}
- Location: tests/features.spec.js:816:3
