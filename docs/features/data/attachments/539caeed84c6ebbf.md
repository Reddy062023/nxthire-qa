...
- Name: tests/features.spec.js >> Feature 12 — Analytics and Reports >> TC-F12-01: 7-day preset filter updates the date range
- Location: tests/features.spec.js:912:3
