...
- Name: tests/features.spec.js >> Feature 6 — Verification Checklist and Duplicate Check >> TC-F06-01: Verification checklist card present on candidate detail
- Location: tests/features.spec.js:492:3
