...
- Name: tests/features.spec.js >> Feature 12 — Analytics and Reports >> TC-F12-05: Per-recruiter table shows submissions under the logged-in recruiter
- Location: tests/features.spec.js:957:3
