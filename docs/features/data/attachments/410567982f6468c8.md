...
- Name: tests/features.spec.js >> Feature 5 — Email Button and Templates >> TC-F05-01: Email button present on candidate detail
- Location: tests/features.spec.js:363:3
