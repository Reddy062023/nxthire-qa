...
- Name: tests/features.spec.js >> Feature 2 — Parse Resume on Create >> TC-F02-02: Parsing an uploaded resume auto-fills candidate fields
- Location: tests/features.spec.js:264:3
