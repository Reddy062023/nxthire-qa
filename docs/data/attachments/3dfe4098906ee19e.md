...
- Name: candidates.spec.js >> TC-11-B Search Scenarios >> Search single character — P — returns results
- Location: candidates.spec.js:181:3
...
Call log:
  - navigating to "https://nxthire.ai/login", waiting until "load"
