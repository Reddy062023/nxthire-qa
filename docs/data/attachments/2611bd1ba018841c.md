...
- Name: openjobs.spec.js >> TC-12-G New Requisition Page >> New requisition form shows JD text area
- Location: openjobs.spec.js:323:3
...
Call log:
  - waiting for locator('button[type="submit"]')
    - locator resolved to <button type="submit" class="btn btn-primary w-full mb-3">…</button>
...
- generic [ref=e3]:
  ...
  - generic [ref=e20]:
    ...
    - generic [ref=e35]:
      ...
      - textbox [active] [ref=e37]: password123
